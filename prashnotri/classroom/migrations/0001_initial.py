# Generated by Django 2.2 on 2019-05-28 19:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(max_length=2550, verbose_name='Question')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attempt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attempt_q', to='classroom.Attempt')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='a+', to='classroom.Answer')),
                ('attempt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='classroom.Attempt')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='classroom.Question')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='attempt',
            name='quiz',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_attempts', to='classroom.Quiz'),
        ),
        migrations.AddField(
            model_name='answer',
            name='question',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['attempt', 'question'], name='classroom_a_attempt_6576ca_idx'),
        ),
        ...
        migrations.AddField(
            ...
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attempt_answer', to='classroom.Student'),
        ),
        migrations.AddField(
            model_name='attempt',
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_attempts', to='classroom.Student'),
        ),
        migrations.AlterUniqueTogether(
            name='user',
        ...
        migrations.AddIndex(
            model_name='attemptanswer',
            index=models.Index(fields=['student'], name='classroom_a_student_a6e0bb_idx'),
        ),
        migrations.AddIndex(
            model_name='attemptanswer',
            index=models.Index(fields=['answer'], name='classroom_a_answer__5b7ab9_idx'),
        ),
        migrations.AddIndex(
            model_name='attemptanswer',
            index=models.Index(fields=['attempt', 'question'], name='classroom_a_attempt_e04638_idx'),
        ),
        migrations.AddIndex(
            model_name='attempt',
            index=models.Index(fields=['student'], name='classroom_a_student_1a21bc_idx'),
        ),
        migrations.AddIndex(
            model_name='attempt',
            index=models.Index(fields=['quiz'], name='classroom_a_quiz_id_eef64a_idx'),
        ),
    ]
